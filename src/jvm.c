...
void run_jvm()
{
	...
	printf("Criando executable_class\n");
	...
	{
		printf("Buscando o metodo clinit\n");
		...
		{
			printf("Executando o metodo clinit\n");
	...
	for (method_info *aux = methods; i < jvm->classes->class_file->methods_count; aux++, i++)
	{
		...
		{
			printf("Executando o metodo main\n");
